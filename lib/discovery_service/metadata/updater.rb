  ...
  module Metadata
    ...
    class Updater
      ...
      def update
        ...
        save_entities(grouped_entities, config[:environment])
      end

      private

      def save_entities(grouped_entities, environment)
      ...
      def save_group_page_content(group, entities, environment)
        page = render(:group, generate_group_model(entities, 'en', environment))
